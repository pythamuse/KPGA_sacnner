...
## 16. Vercel 임시 디스크로 인한 잘못된 장수 불일치 재발

**재현**: 운영 배포본 `v2026-08-06.1`에서 두 19페이지 스캐너 PDF를 업로드한 뒤 CAGI 18장·만족도 19장 `COUNT_MISMATCH`가 반환됨.
