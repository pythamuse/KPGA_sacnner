...
| 6 | B-8, B-5 | 기준선 기하 검증, 정규화 단계 | 회색조 재보정과 묶어 별도 설계 **착수 대기(2026-09-03)** — 사용자가 미룬 회색조 재보정과 같은 설계라 사용자 결정 뒤에. 준비된 것: 세트 4 판정 표본(V2 기준 232/11), `pageIsBinarySource` 계급 신호, 검증 기록 §3.5의 경로 |
