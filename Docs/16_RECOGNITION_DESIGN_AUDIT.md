...
| 4 | ~~**B-7** 근거 구조화 전달~~ **완료 2026-09-03** ([Task/B7_EVIDENCE_2026-09-03.md](../Task/B7_EVIDENCE_2026-09-03.md); B-2의 refused 전달 포함) | B-6(구조화 트레이스)과 함께 한 라운드 | 값 바이트 동일 |
| 5 | ~~B-3·B-9, B-4~~ **완료 2026-09-03** — V2 선 대응 기본값 ON([Task/B3_GRID_FIT_MEASUREMENT_2026-09-03.md](../Task/B3_GRID_FIT_MEASUREMENT_2026-09-03.md) §6: 8개 조건 전부 정답↑·오답 비증가) | 파서 검증 재구조화 — 세트 4가 판정 표본. **계측 완료 2026-09-03** ([Task/B3_GRID_FIT_MEASUREMENT_2026-09-03.md](../Task/B3_GRID_FIT_MEASUREMENT_2026-09-03.md)): 스캔은 균일 이동 절을 안 쓰고, 세트 4 밀림은 앵커 허용치 안에 있다 — B-4가 본체 | 스캔 1~3 동일 + 세트 4 정답↑·오답 비증가 |
| 6 | B-8, B-5 | 기준선 기하 검증, 정규화 단계 | 회색조 재보정과 묶어 별도 설계 **완료 2026-09-03** — B-5: 회색조 계급 보정 병합(세트 4 232/11 → 307/11, 1비트·사진 바이트 동일); B-8: 계측 결과 선택지 표 짝짓기 편차 최대 0.016(간격의 1/5), 거절 규칙 불필요([Task/GRAYSCALE_CLASS_2026-09-03.md](../Task/GRAYSCALE_CLASS_2026-09-03.md)). 준비된 것: 세트 4 판정 표본(V2 기준 232/11), `pageIsBinarySource` 계급 신호, 검증 기록 §3.5의 경로 |
